...
//    @Transactional
//    @Query(value = "COUNT * FROM `customer_vs_coupons` WHERE customer_id = ?1 and coupon_id=?2", nativeQuery = true)
//    Boolean isCouponPurchased(int customer_id, int coupon_id);
